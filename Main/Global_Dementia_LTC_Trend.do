...
export excel using "$table/main/fig1_AAPC.xlsx", replace firstrow(variables) keepcellfmt 
...
export excel using "$table/main/fig1_AbCare.xlsx", replace firstrow(variables) keepcellfmt 
