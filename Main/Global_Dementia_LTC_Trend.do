/***********************************************************************
                Disability, Dementia and LTC (Trend)
************************************************************************

    *Title: Absence of Care Project
    *Aim of This Do-file: Trend Analysis
...
*-----------------------------------------------------------------------
*             Overall Trend in Absence of Care (Fig.1)
*-----------------------------------------------------------------------
...
export excel using "$table/main/fig1.xlsx", replace firstrow(variables) keepcellfmt sheet("fig1_AAPC")
...
save "$temp/fig1_estimates", replace
...
export excel using "$table/main/fig1.xlsx", sheetreplace firstrow(variables) keepcellfmt sheet("fig1_AbCare")

*-----------------------------------------------------------------------
* Plot Fig.1 

use "$temp/fig1_estimates", clear
...
gr export "$figure/main/fig1.png", replace width(5000)   
gr export "$figure/main/fig1.pdf", replace as(pdf)
