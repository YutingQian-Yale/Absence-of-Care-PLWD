...
export excel using "$table/supplementary/efig7_AAPC.xlsx", replace firstrow(variables) keepcellfmt
...
export excel using "$table/supplementary/efig7_AbCare.xlsx", replace firstrow(variables) keepcellfmt 
