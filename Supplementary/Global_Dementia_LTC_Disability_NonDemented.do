...
export excel using "$table/supplementary/efig6_AAC.xlsx", replace firstrow(variables) keepcellfmt
...
export excel using "$table/supplementary/efig6_ADLIADL.xlsx", replace firstrow(varlabels) keepcellfmt
