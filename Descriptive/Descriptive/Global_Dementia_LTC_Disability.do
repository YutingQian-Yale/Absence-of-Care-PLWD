...
export excel using "$table/descriptive/efig2_AAC.xlsx", replace firstrow(variables) keepcellfmt 
...
export excel using "$table/descriptive/efig2_ADLIADL.xlsx", replace firstrow(varlabels) keepcellfmt
