...
export excel using "$table/robustness/efig5_AAPC.xlsx", replace firstrow(variables) keepcellfmt
...
export excel using "$table/robustness/efig5_AbCare.xlsx", replace firstrow(variables) keepcellfmt
