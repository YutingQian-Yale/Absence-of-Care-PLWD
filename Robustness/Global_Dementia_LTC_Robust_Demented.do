...
export excel using "$table/robustness/efig4_AAPC.xlsx", replace firstrow(variables) keepcellfmt
...
export excel using "$table/robustness/efig4_AbCare.xlsx", replace firstrow(variables) keepcellfmt
