...
************************************************************************
    ...
    *Aim of This Do-file: Robustness Check (Demented)
...
*-----------------------------------------------------------------------
*   Overall Trend in Absence of Care (eFig.4: First Demented and After)
*-----------------------------------------------------------------------
...
forvalues i = 1/4{
    ...
    * Restrict to the waves from the dementia and onward
    tab demented_baseD
    keep if demented_baseD == 1
...
export excel using "$table/robustness/efig4.xlsx", replace firstrow(variables) keepcellfmt sheet("efig4_AAPC")
...
save "$temp/robustness/efig4_estimates", replace
...
export excel using "$table/robustness/efig4.xlsx", sheetreplace firstrow(variables) keepcellfmt sheet("efig4_AbCare")

*-----------------------------------------------------------------------
* Plot eFig.4

use "$temp/robustness/efig4_estimates", clear
...
gr export "$figure/robustness/efig4.png", replace width(5000)   
gr export "$figure/robustness/efig4.pdf", replace as(pdf)
