...
export excel using "$table/robustness/efig3_AAPC.xlsx", replace firstrow(variables) keepcellfmt
...
export excel using "$table/robustness/efig3_AbCare.xlsx", replace firstrow(variables) keepcellfmt
