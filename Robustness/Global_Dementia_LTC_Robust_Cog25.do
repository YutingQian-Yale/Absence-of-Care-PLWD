/***********************************************************************
		        Disability, Dementia and LTC (Robustness)
************************************************************************

	*Title: Absence of Care Project
	*Aim of This Do-file: Robustness Check (25-Point Cognitive Scale)
...
*-----------------------------------------------------------------------
*       Overall Trend in Absence of Care (eFig.3: 25-Point Scale)
*-----------------------------------------------------------------------
...
forvalues i = 1/4{
    ...
    * Dementia Sample based on 25-Point Scale
    keep if ragey>=50 & ever_demented_25==1 & radliadl_01==1
...
export excel using "$table/robustness/efig3.xlsx", replace firstrow(variables) keepcellfmt sheet("efig3_AAPC")
...
save "$temp/robustness/efig3_estimates", replace
...
export excel using "$table/robustness/efig3.xlsx", sheetreplace firstrow(variables) keepcellfmt sheet("efig3_AbCare")

*-----------------------------------------------------------------------
* Plot eFig.3 

use "$temp/robustness/efig3_estimates", clear
...
gr export "$figure/robustness/efig3.png", replace width(5000)   
gr export "$figure/robustness/efig3.pdf", replace as(pdf)
